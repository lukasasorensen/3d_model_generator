...
export const writeSse = (res: Response, eventType: SseEventType, data: unknown): void => {
  res.write(`event: ${eventType}\ndata: ${JSON.stringify(data)}\n\n`);
};

export const writeAiStreamEvent = (res: Response, event: OpenScadStreamEvent): void => {
  switch (event.type) {
    case 'code_delta':
