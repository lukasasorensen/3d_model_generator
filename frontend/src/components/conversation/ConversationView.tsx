...
export function ConversationView({ conversation, streaming, scrollContainerRef }: ConversationViewProps) {
  ...
  }, [autoScroll, conversation.messages.length, streaming?.streamingCode, streaming?.status]);
