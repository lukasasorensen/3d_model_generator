  ...
  return (
    <div className={`border rounded-lg p-6 ${getStatusColor()} transition-colors`}>
      <div className="flex items-center gap-3 mb-4">
        {getStatusIcon()}
        <h3 className="text-lg font-semibold text-gray-900">{streaming.statusMessage}</h3>
      </div>
      ...
      {streaming.streamingReasoning && (
        <div className="mt-4">
          <h4 className="text-xs uppercase tracking-wide text-slate-500 mb-2">Reasoning</h4>
